...
% \majorfield[pt]={Engenharia Biomédica}
 \majorfield[en]={Electrical and Computer Engineering}
...
\title[Sentiment Analysis \\ on Product-Service Systems]{Sentiment Analysis on Product-Service Systems}
\subtitle{Diversity}

% Author
% use [f] for female and [m] for male
\authorname[m]{Guilherme Nuno Campos Góis}{Guilherme Góis}
\authordegree{Bachelor}
...
% use [f] for female and [m] for male
\adviser[m]{Rui Alexandre Nunes Neves da Silva}{Full Professor}{\\& NOVA University of Lisbon} 
...
\chapterfile{SotA}
%\chapterfile{Exemplo3}
%\chapterfile{Concept}
%\chapterfile{Development}
%\chapterfile{Validation}
%\chapterfile{Conclusions}
...
% Bib TeX bibliography files. Can be used multiple times with a single file nae each time.
